...
-- @usage global_equality(child, "_G.DefinitionOrReferencesLoaded", true)
...
-- @usage global_type_equality(child, "_G.DefinitionOrReferencesLoaded", "boolean")
...
Helpers.expect.config_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.DefinitionOrReferences.config." .. field, value)
    end,
    errorMessage
)
...
Helpers.expect.config_type_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(
            child,
            "type(_G.DefinitionOrReferences.config." .. field .. ")",
            value
        )
    end,
    errorMessage
...
Helpers.expect.state_equality = MiniTest.new_expectation(
    "state matches",
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.DefinitionOrReferences.enabled." .. field, value)
    end,
    errorMessage
)
...
Helpers.expect.state_type_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(
            child,
            "type(_G.DefinitionOrReferences.state." .. field .. ")",
            value
        )
    end,
    errorMessage
